...
export default function Projects() {
  const projects = [
    ...
    {
      title: 'KUKA Robot Simulation (RoboDK)',
      company: 'Academic Project',
      description: 'Simulated and programmed KUKA industrial robots using RoboDK to optimize motion paths for production tasks.',
      highlights: [
        'Developed motion planning for automated assembly lines',
        'Optimized motion paths for production efficiency and precision',
        'Conducted simulations for real-world manufacturing applications',
        'Analyzed robot kinematics and trajectory planning',
        'Validated assembly line automation scenarios',
      ],
      tech: ['RoboDK', 'KUKA Robotics', 'Industrial Automation', 'Motion Planning', 'Simulation'],
      role: 'Robotics Student',
      color: 'from-neon-orange to-neon-pink',
    },
    {
      title: 'Image Classification Using CNN (CIFAR-10)',
      company: 'Academic Project',
      description: 'Deep learning model for multi-class image classification achieving 80%+ test accuracy on CIFAR-10 dataset with 60,000 images.',
      highlights: [
        'Developed and trained CNN model for 10-category image classification',
        'Achieved over 80% test accuracy on 60,000 images',
        'Applied data normalization and augmentation techniques',
        'Reduced overfitting through regularization strategies',
        'Analyzed performance using accuracy/loss curves and confusion matrices',
        'Benchmarked CNN results against SVM and KNN classifiers',
      ],
      tech: ['Python', 'TensorFlow', 'Keras', 'scikit-learn', 'NumPy', 'Matplotlib'],
